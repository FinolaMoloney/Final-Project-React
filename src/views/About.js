        ...
        <div className="background">
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        <img className="logoTop" src={NourishAndSproutLogo} width="500" height="500" alt="NourishAndSproutLogo" />
                    </div>
                    <div className="col-sm-4">
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <div className="card faq-card">
                            <h6 className="textPara">What can we do if we have an issue with our order?</h6>
